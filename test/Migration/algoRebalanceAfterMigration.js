...
describe('AFiBase - migration testing', () => {
    ...
    context('Algo Rebalance testing', () => {
        ...
        it("Algo Rebalance testing after migration", async () => {
            let depositAmount = 0;
            ...
            // await aTokenConInstanceNew.setPauseDepositController(investor1.address);
        ...
        it("Algo Rebalance testing after migration with same length undelying list", async () => {
            let depositAmount = 0;
        ...
        it("Algo Rebalance testing after migration with more length undelying list", async () => {
            let depositAmount = 0;
