...
describe('AFiBase', () => {
    ...
    context('Basic checks for deposit and withdraw', () => {
        it("withdraw check", async () => {
            ...
            await expect(aFiAFiOracleInstance.connect(investor1).cumulativeSwap(swapParams, 0, oneInchParam, "0x", 985639860)).to.be.reverted;

            await aFiAFiOracleInstance.connect(investor1).cumulativeSwap(swapParams, 0, oneInchParam, "0x", 97563986);
