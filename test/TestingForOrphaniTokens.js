...
//     context('cs checkes for Orphan iTokens', () => {
//         it("check orphan iTokens inn cs", async () => {
...
//             var balOfTheContract = await usdtConInstance.balanceOf(aTokenConInstance.address)
//             console.log("bal before trnafer", `${balOfTheContract}`)
...
//             var preDepBefore = await aFiStorageInstance.getPreSwapDepositsTokens(aTokenConInstance.address, 0, usdcConInstance.address);
//             console.log("PreswapDep before cs ====== ", preDepBefore);

//             await aFiAFiOracleInstance.connect(investor1).cumulativeSwap(swapParams, 0, oneInchParam, "0x");
//             var preDepAfter = await aFiStorageInstance.getPreSwapDepositsTokens(aTokenConInstance.address, 0, usdcConInstance.address);
//             console.log("PreswapDep after cs ====== ", preDepAfter);

//             preDepAfter = await aFiStorageInstance.getPreSwapDepositsTokens(aTokenConInstance.address, 1, usdcConInstance.address);
//             console.log("PreswapDep after cs for the next cs====== ", preDepAfter);

//             expect(preDepAfter).to.be.gt(preDepBefore);
...
//                 197801111576383300n, usdtConInstance.address, deadline, returnString, 3
//             )).to.be.reverted;
...
//                     197801111576383300n, usdtConInstance.address, deadline, returnString, 1
//                 );
...
//                 var preDepBefore = await aFiStorageInstance.getPreSwapDepositsTokens(aTokenConInstance1.address, 0, usdcConInstance.address);
//                 console.log("PreswapDep before cs ====== ", preDepBefore);

//                 await aFiAFiOracleInstance.connect(investor1).cumulativeSwap(swapParams, 0, oneInchParam, "0x");

//                 var preDepAfter = await aFiStorageInstance.getPreSwapDepositsTokens(aTokenConInstance1.address, 1, usdcConInstance.address);
//                 console.log("PreswapDep after cs ====== ", preDepAfter);

//                 expect(preDepAfter).to.equal(preDepBefore);
...
//             it("withdraw check and cs after extra iTokens", async () => {
//                 const beforeUSDTDep = await usdtConInstance.balanceOf(investor1.address)
//                 console.log("before Deposit user usdt balance", `${beforeUSDTDep}`);
...
//                     197801111576383300n, usdcConInstance.address, deadline, returnString, 2
//                 );
