...
describe('AFiOracle main contract', (accounts) => {
    ...
    it('Withdraw in iToken using 1inch when all the underlying tokens removed by AR2 ', async () => {
        ...
        await aTokenConInstance.connect(investor1).pauseUnpauseDeposit(true);
        await aFiAFiOracleInstance.connect(investor1).cumulativeSwap(swapParams, 0, oneInchParam, "0x", 954110957);
        ...
        try {
            ...
            let tokenIn = '0xdac17f958d2ee523a2206206994597c13d831ec7';  // Provide your tokenIn address
            let tokenOut = '0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48'; // Provide your tokenOut address
            let amountIn = '45550070';  // Amount to swap
            ...
            tokenIn = '0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48';  // Provide your tokenIn address
            tokenOut = '0xdac17f958d2ee523a2206206994597c13d831ec7'; // Provide your tokenOut address
            amountIn = '45550070';  // Amount to swap
