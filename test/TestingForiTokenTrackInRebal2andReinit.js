...
//         console.log("PreswapDep before rebal2 ====== ", preDepBefore);
...
//         var preDepBefore = await aFiStorageInstance.getPreSwapDepositsTokens(aTokenConInstance.address, 1, usdcConInstance.address);
//         console.log("PreswapDep after rebal2 ====== ", preDepBefore);
...
//         poolValue = await aFiStorageInstance.calculatePoolInUsd(aTokenConInstance.address);
//         await aTokenConInstance.connect(investor1).pauseUnpauseDeposit(true);
//         await aFiAFiOracleInstance.connect(investor1).cumulativeSwap(swapParams2, 0, oneInchParam, "0x");
...
//         var preDepBefore = await aFiStorageInstance.getPreSwapDepositsTokens(aTokenConInstance.address, 2, usdcConInstance.address);
//         console.log("PreswapDep before reintialize ====== for second cs counter ", preDepBefore);
        
//         var preDepBefore = await aFiStorageInstance.getPreSwapDepositsTokens(aTokenConInstance.address, 3, usdcConInstance.address);
//         console.log("PreswapDep before reintialize ====== for third cs counter ", preDepBefore);
