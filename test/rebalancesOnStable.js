...
describe('A', (accounts) => {
    ...
    describe('Basic checks for deposit and withdraw', () => {
        ...
        it('scenario 1 testing inmanager when stable token is usdt', async () => {
            ...
            let nav0 = await aTokenConInstance1.depositUserNav(investor1.address);
            console.log("User NAVVVVV after first deposit", `${nav0}`)

            checkNav = await aFiFactoryInstance.getPricePerFullShare(aTokenConInstance1.address, aFiStorageInstance.address);
            console.log("check nav before CS and after first deposit", `${checkNav}`);
            ...
            checkNav = await aFiFactoryInstance.getPricePerFullShare(aTokenConInstance1.address, aFiStorageInstance.address);
            console.log("check nav before CS ", `${checkNav}`);
            ...
            checkNav = await aFiFactoryInstance.getPricePerFullShare(aTokenConInstance1.address, aFiStorageInstance.address);
            console.log("check nav after cs", `${checkNav}`);
            ...
            console.log("uTokProp before rebalance", res);
            ...
            checkNav = await aFiFactoryInstance.getPricePerFullShare(aTokenConInstance1.address, aFiStorageInstance.address);
            console.log("check nav brfore cs", `${checkNav}`);
        ...
        // TODO:  Note ** 
        it('scenario 1 testing inmanager when stable token is usdt and multiple deposits', async () => {
            snapshotId = await ethers.provider.send('evm_snapshot');
            console.log("Checkkkkkkkkk");
            await aFiPassiveRebalanceInstance.updateMidToken(
                [
            ...
            checkNav = await aFiFactoryInstance.getPricePerFullShare(aTokenConInstance1.address, aFiStorageInstance.address);
            console.log("check nav before second cs", `${checkNav}`);
            ...
            await aFiAFiOracleInstance.connect(investor1).cumulativeSwap(swapParams, 0, oneInchParam, "0x", 0);
            checkNav = await aFiFactoryInstance.getPricePerFullShare(aTokenConInstance1.address, aFiStorageInstance.address);
            console.log("check nav after second cs", `${checkNav}`);
            ...
            checkNav = await aFiFactoryInstance.getPricePerFullShare(aTokenConInstance1.address, aFiStorageInstance.address);
            console.log("check nav before third cs", `${checkNav}`);
            ...
            await aFiAFiOracleInstance.connect(investor1).cumulativeSwap(swapParams, 0, oneInchParam, "0x", 0);
            checkNav = await aFiFactoryInstance.getPricePerFullShare(aTokenConInstance1.address, aFiStorageInstance.address);
            console.log("check nav after third cs", `${checkNav}`);
        });
