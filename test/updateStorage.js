...
describe('AFiBase', () => {
    ...
    beforeEach(async () => {
        ...
        aFiStorageInstance2 = await AFiStorage.deploy(aFiManagerInstance.address, aFiAFiOracleInstance.address, aFiPassiveRebalanceInstance.address, aFiFactoryInstance.address);
        const payload = [
            [
    ...
    context('Basic checks for deposit and withdraw', () => {
        ...
        it("withdraw check", async () => {
            ...
            await aFiPassiveRebalanceInstance.setStorage(aFiStorageInstance2.address);
            await aFiAFiOracleInstance.setAFiStorage(aFiStorageInstance2.address);
        });
    });
});
