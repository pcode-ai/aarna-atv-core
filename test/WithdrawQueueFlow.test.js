...
describe('AFiOracle', (accounts) => {
    ...
    context('queue flow testing', () => {
        ...
        //     nav2 = await aTokenConInstance.depositUserNav(investor1.address);
        //     console.log("User nav before queue", `${nav2}`);
        ...
        //     nav2 = await aTokenConInstance.depositUserNav(investor1.address);
        //     console.log("User nav before unqueue", `${nav2}`);
