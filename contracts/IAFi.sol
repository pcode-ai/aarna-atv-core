...
interface IAFi {
  ...
  struct PoolsData {
    ...
    bytes32[] _depositCoinOracleID;
    bytes underlyingData;
    address[] _sumer;
    address[] _aaveToken;
    bytes32[] _priceOraclesID;
