...
describe('AFiBase - migration testing', () => {
    ...
    context('Rebalance scenario testing', () => {
        ...
        it("Rebalance scenario 1 testing after migration in the new vault when itoken is USDT", async () => {
            let depositAmount = 0;
        ...
        it("Rebalance scenario 1 testing after migration in the new vault when itoken is USDC", async () => {
            let depositAmount = 0;
        ...
        it("Rebalance scenario 1 testing after migration in the new vault when itoken is DAI", async () => {
            let depositAmount = 0;
        ...
        it("Rebalance scenario 2 testing after migration in the new vault when itoken is USDT", async () => {
            let depositAmount = 0;
        ...
        it("Rebalance scenario 2 testing after migration in the new vault when itoken is USDC", async () => {
            let depositAmount = 0;
