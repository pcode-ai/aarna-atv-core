...
describe('AFi Product 101', (accounts) => {
    ...
    it("rebalancing by AR1 and reinitalization of vault", async () => {
        ...
        await aFiPassiveRebalanceInstance.setDexForTokenPair("0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48", "0xdac17f958d2ee523a2206206994597c13d831ec7", 1);
        await aFiPassiveRebalanceInstance.setDexForTokenPair("0xdac17f958d2ee523a2206206994597c13d831ec7", "0x58b6a8a3302369daec383334672404ee733ab239", 1);
        await aFiPassiveRebalanceInstance.setDexForTokenPair("0xdac17f958d2ee523a2206206994597c13d831ec7", "0x0954906da0bf32d5479e25f46056d22f08464cab", 1);
        await aFiPassiveRebalanceInstance.setDexForTokenPair("0xdac17f958d2ee523a2206206994597c13d831ec7", "0xc221b7e65ffc80de234bbb6667abdd46593d34f0", 1);
        await aFiPassiveRebalanceInstance.setDexForTokenPair("0xdac17f958d2ee523a2206206994597c13d831ec7", "0xc18360217d8f7ab5e7c516566761ea12ce7f9d72", 1);
        await aFiPassiveRebalanceInstance.setDexForTokenPair("0xdac17f958d2ee523a2206206994597c13d831ec7", "0x9f8f72aa9304c8b593d555f12ef6589cc3a579a2", 1);
        ...
        await aFiPassiveRebalanceInstance.setDexForTokenPair("0x58b6a8a3302369daec383334672404ee733ab239", "0xdac17f958d2ee523a2206206994597c13d831ec7", 1);
        await aFiPassiveRebalanceInstance.setDexForTokenPair("0x0954906da0bf32d5479e25f46056d22f08464cab", "0xdac17f958d2ee523a2206206994597c13d831ec7", 1);
        await aFiPassiveRebalanceInstance.setDexForTokenPair("0xc221b7e65ffc80de234bbb6667abdd46593d34f0", "0xdac17f958d2ee523a2206206994597c13d831ec7", 1);
        await aFiPassiveRebalanceInstance.setDexForTokenPair("0x9f8f72aa9304c8b593d555f12ef6589cc3a579a2", "0xdac17f958d2ee523a2206206994597c13d831ec7", 1);
        await aFiPassiveRebalanceInstance.setDexForTokenPair("0xdac17f958d2ee523a2206206994597c13d831ec7", "0xdac17f958d2ee523a2206206994597c13d831ec7", 1);
        ...
        await aFiPassiveRebalanceInstance.setDexForTokenPair("0xdac17f958d2ee523a2206206994597c13d831ec7", "0x7d1afa7b718fb893db30a3abc0cfc608aacfebb0", 1);
        await aFiPassiveRebalanceInstance.setDexForTokenPair("0xdac17f958d2ee523a2206206994597c13d831ec7", "0xd533a949740bb3306d119cc777fa900ba034cd52", 1);
        await aFiPassiveRebalanceInstance.setDexForTokenPair("0xdac17f958d2ee523a2206206994597c13d831ec7", "0x111111111117dc0aa78b770fa6a738034120c302", 1);
        ...
        await aFiPassiveRebalanceInstance.setDexForTokenPair("0xc18360217d8f7ab5e7c516566761ea12ce7f9d72", "0xdac17f958d2ee523a2206206994597c13d831ec7", 1);
        await aFiPassiveRebalanceInstance.setDexForTokenPair("0x7d1afa7b718fb893db30a3abc0cfc608aacfebb0", "0xdac17f958d2ee523a2206206994597c13d831ec7", 1);
        await aFiPassiveRebalanceInstance.setDexForTokenPair("0xd533a949740bb3306d119cc777fa900ba034cd52", "0xdac17f958d2ee523a2206206994597c13d831ec7", 1);
        await aFiPassiveRebalanceInstance.setDexForTokenPair("0x111111111117dc0aa78b770fa6a738034120c302", "0xdac17f958d2ee523a2206206994597c13d831ec7", 1);
        await aFiPassiveRebalanceInstance.setDexForTokenPair("0x95ad61b0a150d79219dcf64e1e6cc01f0b64c4ce", "0xdac17f958d2ee523a2206206994597c13d831ec7", 1);

        await aTokenConInstance.connect(investor1).pauseUnpauseDeposit(true);
        let swap10;
        try {
            await sleep(1000);
            let tokenIn = '0xC18360217D8F7Ab5e7c516566761Ea12Ce7F9D72';  // Provide your tokenIn address
            let tokenOut = '0xdac17f958d2ee523a2206206994597c13d831ec7'; // Provide your tokenOut address
            let amountIn = '5192996523173636529';  // Amount to swap
            let from = aTokenConInstance.address;     // Provide the from address
            let origin = aTokenConInstance.address;

            swap10 = await swapTokens2(
                tokenIn,
                tokenOut,
                amountIn,
                from,
        ...
        try {
            await sleep(1000);
            let tokenIn = '0x7d1afa7b718fb893db30a3abc0cfc608aacfebb0';  // Provide your tokenIn address
            let tokenOut = '0xdac17f958d2ee523a2206206994597c13d831ec7'; // Provide your tokenOut address
            let amountIn = '214754292564241027420';  // Amount to swap
            let from = aTokenConInstance.address;     // Provide the from address
            let origin = aTokenConInstance.address;

            swap11 = await swapTokens2(
                tokenIn,
                tokenOut,
                amountIn,
                from,
        ...
        try {
            await sleep(1000);
            let tokenIn = '0xd533a949740bb3306d119cc777fa900ba034cd52';  // Provide your tokenIn address
            let tokenOut = '0xdac17f958d2ee523a2206206994597c13d831ec7'; // Provide your tokenOut address
            let amountIn = '125151456589681378152';  // Amount to swap
            let from = aTokenConInstance.address;     // Provide the from address
            let origin = aTokenConInstance.address;

            swap12 = await swapTokens2(
                tokenIn,
                tokenOut,
                amountIn,
                from,
        ...
        try {
            await sleep(1000);
            let tokenIn = '0x111111111117dc0aa78b770fa6a738034120c302';  // Provide your tokenIn address
            let tokenOut = '0xdac17f958d2ee523a2206206994597c13d831ec7'; // Provide your tokenOut address
            let amountIn = '309487539861451407865';  // Amount to swap
            let from = aTokenConInstance.address;     // Provide the from address
            let origin = aTokenConInstance.address;

            swap13 = await swapTokens2(
                tokenIn,
                tokenOut,
                amountIn,
                from,
        ...
        try {
            await sleep(1000);
            let tokenIn = '0x95ad61b0a150d79219dcf64e1e6cc01f0b64c4ce';  // Provide your tokenIn address
            let tokenOut = '0xdac17f958d2ee523a2206206994597c13d831ec7'; // Provide your tokenOut address
            let amountIn = '6191026864629026336323580';  // Amount to swap
            let from = aTokenConInstance.address;     // Provide the from address
            let origin = aTokenConInstance.address;

            swap14 = await swapTokens2(
                tokenIn,
                tokenOut,
                amountIn,
                from,
        ...
        try {
            ...
            tokenIn = '0xdac17f958d2ee523a2206206994597c13d831ec7';  // Provide your tokenIn address
            tokenOut = '0xc944e90c64b2c07662a292be6244bdf05cda44a7'; // Provide your tokenOut address
            amountIn = '275861629';  // Amount to swap
            from = aTokenConInstance.address;     // Provide the from address
            origin = aTokenConInstance.address;

            oneInchdata1 = await swapTokens2(
                tokenIn,
                tokenOut,
                amountIn,
                from,
            ...
            tokenIn = '0xdac17f958d2ee523a2206206994597c13d831ec7';  // Provide your tokenIn address
            tokenOut = '0xaf5191b0de278c7286d6c7cc6ab6bb8a73ba2cd6'; // Provide your tokenOut address
            amountIn = '275861629';  // Amount to swap
            from = aTokenConInstance.address;     // Provide the from address
            origin = aTokenConInstance.address;

            oneInchdata2 = await swapTokens2(
                tokenIn,
                tokenOut,
                amountIn,
                from,
            ...
            tokenIn = '0xdac17f958d2ee523a2206206994597c13d831ec7';  // Provide your tokenIn address
            tokenOut = '0x1f9840a85d5af5bf1d1762f925bdaddc4201f984'; // Provide your tokenOut address
            amountIn = '225861629';  // Amount to swap
            from = aTokenConInstance.address;     // Provide the from address
            origin = aTokenConInstance.address;

            oneInchdata3 = await swapTokens2(
                tokenIn,
                tokenOut,
                amountIn,
                from,
            ...
            tokenIn = '0xdac17f958d2ee523a2206206994597c13d831ec7';  // Provide your tokenIn address
            tokenOut = '0x7420b4b9a0110cdc71fb720908340c03f9bc03ec'; // Provide your tokenOut address
            amountIn = '275861629';  // Amount to swap
            from = aTokenConInstance.address;     // Provide the from address
            origin = aTokenConInstance.address;

            oneInchdata4 = await swapTokens2(
                tokenIn,
                tokenOut,
                amountIn,
                from,
            ...
            tokenIn = '0xdac17f958d2ee523a2206206994597c13d831ec7';  // Provide your tokenIn address
            tokenOut = '0x6123b0049f904d730db3c36a31167d9d4121fa6b'; // Provide your tokenOut address
            amountIn = '275861629';  // Amount to swap
            from = aTokenConInstance.address;     // Provide the from address
            origin = aTokenConInstance.address;

            oneInchdata5 = await swapTokens2(
                tokenIn,
                tokenOut,
                amountIn,
                from,
        ...
        var oneInchParam1 = {
            ...
            secondIterationUnderlyingSwap: [],
            firstIterationCumulativeSwap: ["0x", "0x", "0x"],
            secondIterationCumulativeSwap: [oneInchdata1, oneInchdata2, oneInchdata3, oneInchdata4, oneInchdata5]
        }
        console.log("check balance", await usdcConInstance.balanceOf(aTokenConInstance.address));
        console.log("check balance1", await usdtConInstance.balanceOf(aTokenConInstance.address));
        await aFiPassiveRebalanceInstance.setDexForTokenPair("0xdac17f958d2ee523a2206206994597c13d831ec7", "0xc944e90c64b2c07662a292be6244bdf05cda44a7", 1);
        await aFiPassiveRebalanceInstance.setDexForTokenPair("0xdac17f958d2ee523a2206206994597c13d831ec7", "0xaf5191b0de278c7286d6c7cc6ab6bb8a73ba2cd6", 1);
        ...
        await aFiPassiveRebalanceInstance.setDexForTokenPair("0xdac17f958d2ee523a2206206994597c13d831ec7", "0x7420b4b9a0110cdc71fb720908340c03f9bc03ec", 1);
        await aFiPassiveRebalanceInstance.setDexForTokenPair("0xdac17f958d2ee523a2206206994597c13d831ec7", "0x6123b0049f904d730db3c36a31167d9d4121fa6b", 1);
        console.log("reinitialise starts here");

        await aFiPassiveRebalanceInstance.updateRebalStrategyNumberByOwner(aTokenConInstance.address, 1);

        let reInitializeVault = await aFiPassiveRebalanceInstance.getRebalStrategyNumber(aTokenConInstance.address);
        console.log("reInitializeVault", reInitializeVault);
        ...
        console.log("reinitialise starts ends");
        ...
        check = await aTokenConInstance.getProportions();
        console.log("after rebal default proportion -----------------------------------", check[1]);
